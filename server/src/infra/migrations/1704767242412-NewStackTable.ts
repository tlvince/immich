...
export class NewStackTable1704767242412 implements MigrationInterface {
    name = 'NewStackTable1704767242412'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "asset_stack" ("id" character varying NOT NULL, "primaryAssetId" uuid NOT NULL, CONSTRAINT "REL_91704e101438fd0653f582426d" UNIQUE ("primaryAssetId"), CONSTRAINT "PK_74a27e7fcbd5852463d0af3034b" PRIMARY KEY ("id"))`);
